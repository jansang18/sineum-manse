...
$ArtifactBaseName = 'jansang-manse-building-lookup-v2.2-release'
$ReleaseWebFiles = @(
    'index.html',
...
$ProtectedFiles = @('index.html', 'annual-reading.js', 'reading.js', 'unified-reading.js', 'building-lookup.js', 'life-model.js', 'life-forecast.js', 'nav.js', 'share.js')

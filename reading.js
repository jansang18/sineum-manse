    ...
    return {
      ...
      sections: [
        ...
        },
        {
          ...
          lead: moneyStructure,
          paragraphs: [
            '현재 재물 판정은 ' + moneyScore + '점, ' + scorePhrase(moneyScore) + '입니다. 점수가 높다고 무조건 쌓이는 것이 아니고 낮다고 벌 수 없는 것도 아닙니다. 점수는 ' + year + '년에 돈이 움직이는 압력이고, 실제 잔고는 계약·가격·현금흐름 관리가 결정합니다.',
            outputCount >= 2
        ...
        },
        {
          ...
          lead: workStructure,
          paragraphs: [
            year + '년 직업 판정은 ' + jobScore + '점입니다. 중요한 것은 이직 여부 하나가 아니라, 지금 자리에서 책임과 권한의 비율이 맞는지입니다. 책임은 계속 늘어나는데 결정권과 보상이 그대로라면 운이 나빠서가 아니라 구조가 이미 기울어진 것입니다.',
            strong
        ...
        },
        {
          ...
          paragraphs: [
            year + '년 관계의 온도는 ' + loveScore + '점, ' + scorePhrase(loveScore) + '입니다. 인연의 유무보다 중요한 것은 어떤 상태의 내가 누구에게 끌리는가입니다. 지쳤을 때 강한 사람에게 기대고, 답답할 때 불안정한 사람에게 설레는 식이라면 상대가 아니라 자신의 결핍이 선택하고 있을 가능성이 큽니다.',
        ...
        },
        {
          ...
          title: year + '년은 운이 오는 해가 아니라, 운을 다루는 방식이 드러나는 해입니다',
          lead: '세운 천간의 ' + seunStemGod + ', 지지의 ' + seunBranchGod + '이 현재 대운의 ' + daeunGod + ' 위로 들어옵니다. 종합 압력은 ' + overallScore + '점입니다.',
          paragraphs: [
            overallScore >= 65
              ? '문이 열릴 때 가장 위험한 착각은 들어오는 제안을 전부 기회라고 믿는 것입니다. ' + year + '년은 선택지가 늘수록 기준이 필요합니다. 하고 싶은 일보다 남길 수 있는 일을 고르면 운의 크기가 실적과 자산으로 남습니다.'
              : year + '년은 큰 승부보다 정리의 정확도가 중요합니다. 불리한 흐름은 인생 전체의 실패가 아니라 잘못 연결된 비용을 드러내는 조명입니다. 사람·일·지출 가운데 반복해서 새는 한 곳을 막는 것이 새 일을 벌이는 것보다 효과가 큽니다.',
            harmony > conflict
            ...
            '용신으로 잡힌 ' + yongsin + '의 기능을 생활에 끌어오는 것이 ' + year + '년의 실전 열쇠입니다. 상징을 소비하는 대신 ' + ELEMENTS[clampIndex(input.yongsinIndex, ELEMENTS.length)].practice + '이 실제 개운에 가깝습니다.'
          ],
      ...
      closing: {
        ...
        rules: [
          ...
          deficient.practice + '.',
          year + '년의 큰 결정은 감정이 가장 뜨거운 날 바로 확정하지 말 것.'
        ]
      }
    };
  }
